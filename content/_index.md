...
主要数学标签（包括可能永远不会触及的方向）[^math-classify]
- 数学的基础：数理逻辑 | 集合论 | 类型论
...
计算机相关：
- 计算机理论：[函数式编程](/tags/函数式编程/) | [算法](/tags/算法/) | [密码学](/tags/密码学/) | [图形学](/tags/图形学/)
- 系统与体系：[Julialang 中文学习指导](https://learn.juliacn.com/)

---

物理相关：
- [经典物理](/tags/经典物理/) | [量子物理](/tags/量子物理/)
