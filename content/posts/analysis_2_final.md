...
{% <question title="习题课 W8 6 Arzela-Ascoli 引理"> %}
...
{% <theorem title="Cauchy-Hadamard 定理"> %}
...
{% <question title="Sophomore's Dream"> %}
...
### 连续函数多项式逼近
{% <theorem title="Weierstrauss 第一逼近定理"> %}
...
{% <question title="习题课 W11 11 Vitali 覆盖"> %}
...
{% <question title="2020 P3 压缩映射原理一种形式"> %}
