...
对于概率论（和统计）中有频率学派（Frequentist）和贝叶斯学派（Bayesian）两大流派。后者引入了先验概率和后验概率的概念，在人工智能时代获得了更多的支持。在《概率论沉思录》一书中，作者采取了更广阔的视角，试图解决直觉相互矛盾的问题，以及揭示先验信息的巨大影响。
...
我们有 $h(r) = \begin{pmatrix} n\\\\ r \end{pmatrix} f^r(1-f)^{n-r}$
