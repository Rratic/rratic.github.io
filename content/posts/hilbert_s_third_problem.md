...
这是 1900 年希尔伯特《数学问题》演讲[^hilbert23reprinted]提出的 23 个问题中最早得到解决的。
...
该问题由 Max Dehn 在 1901 年 9 月使用不变量解决。[^paper-dehn]此后 Jean-Pierre Sydler 于 1965 年证明体积与 Dehn 不变量都相同的多面体一定可通过互相剪拼得到。[^paper-sydler]
...
对一个多面体，设其 $n$ 个棱长为 $l_1, l_2, \dots, l_n$，对应的二面角为 $\theta _1, \theta _2, \dots, \theta _n$，则 Dehn 不变量被定义为：
...
棱长为 1 的正四面体的 Dehn 不变量为 $(6, 2\arctan\frac{\sqrt{2}}{2})$​，这不能化约成 $0$. 否则，存在 $\frac{a}{b}\in\mathbb{Q}$ 使得 $\tan(\frac{a}{b}\pi)=\frac{\sqrt{2}}{2}$。

一方面，设 $y=e^{i\frac{a}{b}\pi}$，则这等于 $-i\frac{y^2-1}{y^2+1}$，满足 $2(y^2-1)^2+(y^2+1)^2=0$. 另一方面 $y$ 为单位根，极小多项式是分圆多项式，枚举知不成立。
