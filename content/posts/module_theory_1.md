...
### 自由模
对幺环 $R$ 和 R-模 $M$，它的子集 $S$ 称为 M-**线性无关**的，如果对 $S$ 的任意有限子集 $\set{x_1, x_2, \cdots , x_n}$ 有 $x_1a_1+\cdots+x_na_n=0$ 蕴含 $a_1=\cdots=a_n=0$.
...
设它的一组基 $\set{x_1, x_2, \cdots , x_r}$，由 $R$ 是交换幺环，它有极大理想。取一个极大理想 $\mathfrak{M}$，令 $N = x_1\mathfrak{M}+\cdots +x_r\mathfrak{M}$，则它是 $M$ 的一个子模。
